export const copy = {
  ...
  rebootTitle: "Reboot to finish",
  rebootBody: "These writes need a reboot before they take effect. After you come back, the app rechecks them.",
  rebootNow: "Reboot now",
  rebootLater: "Later",
  rebootPending: "A reboot is still needed for applied items.",
  rebootReviewTitle: "After reboot",
  rebootReviewLead: "These items needed a reboot. This is their state now.",
  rebootReviewOk: "At target",
  rebootReviewFail: "Not at target",
  rebootAck: "OK",
  already: "At target",
  check: "Check only",
  cache: "No backup",
  ...
  updateMiss: "Could not reach GitHub for an update check.",
  updateOpen: "Open release",
  updateDownload: "Install latest",
  updateReady: "A newer GitHub release is available.",
  updateInstalling: "Downloading the latest installer.",
  version: "Version",
